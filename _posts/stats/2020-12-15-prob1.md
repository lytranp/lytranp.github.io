...
2 ways to check for independence
...
+ Because we knew that the die is odd, we have 3 possibilities in total: 1, 3 or 5. Because each are equally likely, P(die is 5|die is odd) = 1/3
